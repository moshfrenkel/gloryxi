...
const D = {
  ...
  lg_invite:    { en: (n) => 'Join my GloryXI league "' + n + '". One football challenge a day, build your dream XI, and our own private table. Come see who really knows their football:', he: (n) => 'הצטרפו לליגה שלי "' + n + '" ב-GloryXI. אתגר כדורגל יומי, נבחרת חלומות משלכם, וטבלה פרטית רק שלנו. בואו נראה מי באמת מבין:' },
  lg_playing_as: { en: 'Playing as', he: 'משחק בתור' },
  lg_change_name: { en: 'change', he: 'שנה' },
  lg_set_name:  { en: 'SET YOUR NAME FOR THE TABLE', he: 'קבע את השם שלך לטבלה' },
  lg_name_prompt: { en: 'Your name on the league table:', he: 'השם שלך בטבלת הליגה:' },
  lg_empty_cta: { en: 'Nobody has played in this league yet today. Be the first, or invite the crew.', he: 'עוד אף אחד לא שיחק בליגה היום. תהיה הראשון, או הזמן את החבר׳ה.' },
  ...
  s5_hint:    { en: 'SET YOUR APPROACH, THEN PLAY EACH MATCH', he: 'בוחרים גישה, ואז משחקים כל משחק' },
  tac_vs:     { en: 'NEXT', he: 'הבא' },
  ment_bunker:{ en: 'BUNKER', he: 'בונקר' },
  ment_def:   { en: 'DEFENSIVE', he: 'הגנתי' },
  ment_bal:   { en: 'BALANCED', he: 'מאוזן' },
  ment_atk:   { en: 'ATTACKING', he: 'התקפי' },
  ment_allout:{ en: 'ALL-OUT', he: 'התקפי מאד' },
  read_favorite:{ en: 'FAVOURITE', he: 'פייבוריט' },
  read_even:  { en: 'EVEN MATCH', he: 'שקול' },
  read_underdog:{ en: 'UNDERDOG', he: 'אנדרדוג' },
